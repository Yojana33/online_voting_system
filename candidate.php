  ...
  <div class="container-fluid" id="cont-3">
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        $sql = "select * from candidates where year=1 and approve_status='1'";
          ...
          <div class="col-md-6">
            ...
            <div class="Footer">
              <ul style="display: flex;">
                <li style="list-style: none; padding: 10px; "><a href="index.html" style="text-decoration: none; color: seagreen;">Home</a></li>
