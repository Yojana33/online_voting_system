...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            session_start();
                  ...
                  ?>
                        ...
                        <td class="td-1"><input type="text"  name="username" style="text-align: left;" readonly value="<?php  echo $_SESSION['username']; ?>" required></td>
                    </tr>
                    <tr>
                        <td class="td-1">Name :</td>
                        <td class="td-1"><input type="text" style="text-align: left;" name="txtName" readonly value="<?php  echo $_SESSION['user_name']; ?>" required></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="td-1">Confirm Candidate :</td>
					<td class="td-1"><select required name="txtCand" required>
            <option>--------Select--------</option>
            <?php 
   

        $sql = "select id,name from candidates where year=2 and approve_status='1'";
        ...
        foreach ($results as $output) {?>
          <option value="<?php echo $output["id"]; ?>"><?php echo $output["name"];?></option>
<?php }?>
                    ...
                    <tr>
                        ...
                        <td class="td-1" required><input type="text"textarea style="text-align: left;" name="txtReason" id="" cols="23" rows="4" placeholder="Why You Vote This Candidate any Reason ?"></textarea></td>
                    </tr>
                    <!-- <tr>
                        <td class="td-1">Year :</td>
                        <td class="td-1" required><input type="number" style="text-align: left;" name="txtYear"></td>
                    </tr> -->
                    <tr>
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <ul style="display: flex;">
                  <li style="list-style: none; padding: 10px; "><a href="homepage.php" style="text-decoration: none; color:seagreen;">Home</a></li>
                  <li style="list-style: none; padding: 10px; "><a href="about.php" style="text-decoration: none; color:seagreen;">About</a></li>
                  <li style="list-style: none; padding: 10px; "><a href="contact_form.php" style="text-decoration: none; color:seagreen;">Contact</a></li>
                </ul>
        </div>
      </div>
      <div class="col-md-6">
