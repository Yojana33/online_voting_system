...
<body>
    ...
    <div class="container">
            ...
            session_start();
                  ...
                  ?>
                    ...
                    <tr>
                        ...
                        <td class="td-1"><input type="text" style="text-align: left;" readonly value="<?php  echo $_SESSION['user_name']; ?>" name="txtName" required></td>
                    </tr>
                    <tr>
        ...
        $sql = "select id,name from candidates where year=3 and approve_status='1'";
